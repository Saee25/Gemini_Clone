  ...
  return (
    <div className='main'>
      ...
      <div className='main-container'>
        ...
        ?<>
        <div className="greet">
            <p><span className='span'>Hello, Saee.</span></p>
        ...
        <div className="cards">
            ...
            <div className="card" onClick={() => onSent("Briefly Summize this concept: Urban Planning.")}>
                <p>Briefly Summize this concept: Urban Planning.</p>
            ...
            <div className="card" onClick={() => onSent("Improve the readabiliy of the following code")}>
